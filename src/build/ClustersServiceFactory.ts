...
import { ClustersCommandableHttpServiceV1 } from '../services/version1/ClustersCommandableHttpServiceV1';
...
export class ClustersServiceFactory extends Factory {
	...
	public static HttpServiceDescriptor = new Descriptor("service-clusters", "service", "commandable-http", "*", "1.0");
	...
	constructor() {
		...
		this.registerAsType(ClustersServiceFactory.HttpServiceDescriptor, ClustersCommandableHttpServiceV1);
	}
